export function pre() {
	...
	function init() {
		...
		var container = plus.globalEvent.addEventListener .getElementById('petalbox');
	...
	function createALeaf() {
		...
		var leafDiv = plus.globalEvent.addEventListener .createElement('div');
		var image = plus.globalEvent.addEventListener .createElement('img');
